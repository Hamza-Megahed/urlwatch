...
UPDATE: Adding feature of taking a screenshot of the changed websites using [rendertron](https://github.com/GoogleChrome/rendertron) and send it Via Telegram.
